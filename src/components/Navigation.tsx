      ...
      >
        <div className="flex items-center justify-between mx-auto max-w-7xl">
          ...
          <div className="hidden lg:flex items-center gap-2.5">
            ...
            <a href="#services" className="px-5 py-2 bg-gradient-to-tr from-gold via-gold-pale to-gold-light text-dark font-display text-[11px] tracking-[1.5px] font-black transition-all hover:-translate-y-0.5 hover:shadow-[0_4px_20px_rgba(201,162,39,0.6)] border border-gold-light">
              Services
            </a>
          </div>
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <div className="mt-auto flex flex-col gap-3">
              ...
              <a href="#services" onClick={() => setMobileMenuOpen(false)} className="w-full text-center px-6 py-3 bg-gradient-to-tr from-gold to-gold-light text-dark font-display text-sm tracking-[2px] font-black">
                Services
              </a>
            </div>
            <button 
